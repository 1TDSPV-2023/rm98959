...
// //Inserir itens ao final do array com o método push(item);
// frutas.push("kiwi");
// console.log(frutas);

// //Inserir itens no início do array com o método unshift();
// frutas.unshift("melancia");
// console.log(frutas);

// //Remover itens do final do array com o método pop(); - remove do final do array
// frutas.pop("kiwi");
// console.log(frutas);

// //Remover itens do inicio do array com o método shift(); - remove do inicio do array
// frutas.shift();
// console.log(frutas);
...
// //Utilizando o método splice(indice do item, qtd de vezes que ele será removido), para remover um iten do array em conjunto com o indexOf(item).
